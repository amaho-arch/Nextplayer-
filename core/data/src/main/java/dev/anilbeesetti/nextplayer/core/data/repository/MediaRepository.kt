...
interface MediaRepository {
    ...
    suspend fun updateIntroTimestamps(uri: String, introStartMs: Long, introEndMs: Long)
    suspend fun getIntroTimestamps(uri: String): Pair<Long, Long>?
    suspend fun updateFolderIntroTimestamps(folderPath: String, introStartMs: Long, introEndMs: Long)
    suspend fun getFolderIntroTimestamps(folderPath: String): Pair<Long, Long>?
    suspend fun clearFolderIntroTimestamps(folderPath: String)
}
