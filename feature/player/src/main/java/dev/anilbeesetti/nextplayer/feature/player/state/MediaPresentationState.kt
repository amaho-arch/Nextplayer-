...
class MediaPresentationState(
    ...
    var introStartMs: Long = 0
        private set

    var introEndMs: Long = 0
        private set

    var hasIntro: Boolean = false
        private set
    ...
    private fun updateIntroTimestamps() {
        val metadata = player.currentMediaItem?.mediaMetadata
        introStartMs = metadata?.introStartMs ?: 0L
        introEndMs = metadata?.introEndMs ?: 0L
        hasIntro = introStartMs > 0 && introEndMs > introStartMs
    }
